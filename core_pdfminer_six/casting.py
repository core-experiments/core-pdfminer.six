...
def safe_matrix(a: Any, b: Any, c: Any, d: Any, e: Any, f: Any) -> Matrix | None:
    ...
    if a_f is None or b_f is None or c_f is None or d_f is None or e_f is None or f_f is None:
        return None
...
def safe_cmyk(c: Any, m: Any, y: Any, k: Any) -> tuple[float, float, float, float] | None:
