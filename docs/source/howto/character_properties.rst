...
[simple1.pdf](https://raw.githubusercontent.com/core-experiments/core-pdfminer.six/main/tests/fixtures/samples/simple1.pdf).
...
.. code-block:: python
    ...
    path = Path('tests/fixtures/samples/simple1.pdf').expanduser()
